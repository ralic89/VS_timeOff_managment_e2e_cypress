...
describe("VivifyScrum testing", () => {
  ...
  it("Go to TimeOff tab", () => {
    ...
    general.memberHeaderTitle.should("be.visible").and("have.text", "Member");
  });
  ...
  it("Add Number of vacation days on this day", () => {
    ...
    general.totalNmbrOfUnusedDays
      .should("be.visible")
      .and("contain", numberOfVacationDays);
    general.SuccessfulUpdate.should("be.visible").and(
      "have.text",
      "Successfully updated number of vacation days on this day"
    );
  });

  it("Add vacaction event", () => {
    navigation.chooseVacation();
    general.vacationAssert
      .should("be.visible")
